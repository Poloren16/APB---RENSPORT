...
class _OwnerActivityPageState extends State<OwnerActivityPage> {
  ...
  List<Map<String, dynamic>> _getOwnerTransactions([String? venueName]) {
    ...
    final List<Map<String, dynamic>> all = [...BookingHistoryPage.mockHistory, ...BookingHistoryPage.mockPastHistory];
    final List<Map<String, dynamic>> ownerTx = all.where((b) => ownerVenueNames.contains(b['venueName'])).toList();
