    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => AddVenuePage(ownerUsername: widget.ownerUsername)),
                 ...
                 IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AddVenuePage(venueToEdit: venue, index: globalIndex, ownerUsername: widget.ownerUsername),
                      ),
